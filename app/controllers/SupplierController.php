...
class SupplierController
{
    ...
    public function delete(): void
    {
        ...
        try {
            ...
            $this->flash->add('success', 'Proveedor eliminado correctamente.');
        } catch (RuntimeException $e) {
            $messages = [
                'selected_process' => 'No se puede eliminar porque fue seleccionado en un proceso.',
                'selected_provider_evaluation' => 'No se puede eliminar porque fue seleccionado en un proceso.',
                'purchase_orders' => 'No se puede eliminar porque tiene órdenes de compra asociadas.',
                'approved_requests' => 'No se puede eliminar porque tiene contratos o procesos activos.',
                'active_processes' => 'No se puede eliminar porque tiene contratos o procesos activos.',
